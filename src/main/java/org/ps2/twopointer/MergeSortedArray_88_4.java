 ...
 */
public class MergeSortedArray_88_4 {
    /**
     * basic ga we have two arrays nums1, nums2, m-->nums1 lo valid elements  n-->nums2 lo valid elements
     * we need to merge that in sorted order in nums1 means m+n <nums1.length vuntadi
     * now we will take elements from backward direction
     * i=m-1,j=n-1;
     * while(i>=0&&j>=0)
     *  we will check and compare elements between nums1 and num2 map them accordingly then we will add remaining elements
     */
